  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
    <div className="pt-32 pb-12 md:pt-40 md:pb-20">
      ...
      <div>
        <div>
          <div
            className="relative flex justify-center mb-8 aos-init aos-animate"
            data-aos="zoom-y-out"
            data-aos-delay={450}
          >
            <div className="flex flex-col justify-center">
              <img
                ...
                srcSet="https://simple.cruip.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fhero-image.aff77a9d.png&w=828&q=75"
                src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fhero-image.aff77a9d.png&w=1920&q=75"
              />
              <svg
